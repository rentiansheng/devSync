...
int send_without_execute_result(http_connect_t *con)
{
	...
	strcat(msg, "The most recent compilation result was not found, and the value of the most recently compiled result was saved for a maximum of one days");
